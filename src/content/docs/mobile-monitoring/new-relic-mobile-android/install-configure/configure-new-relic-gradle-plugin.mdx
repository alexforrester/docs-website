...
<CollapserGroup>
  ...
  >
    Multiple build types can be specified, separated by commas. If you have multiple application variants (flavors) of a build type then these will all be built.
